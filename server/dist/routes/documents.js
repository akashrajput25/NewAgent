...
router.post('/upload', upload.single('file'), async (req, res) => {
    ...
    const result = db.prepare('INSERT INTO documents (conversation_id, filename, original_name, mime_type, size) VALUES (?, ?, ?, ?, ?)').run(conversationId ? Number(conversationId) : null, req.file.filename, req.file.originalname, req.file.mimetype, req.file.size);
